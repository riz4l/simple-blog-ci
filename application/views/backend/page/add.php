	    	...
	    	<div class="row">
	    		<div class="dashboard">
		    		...
		    		<div class="col-md-9">
		    			...
		    			?>
						<form name="form1" action="<?php echo base_url()?>Pagemanagement/add_function" method="post" enctype="multipart/form-data">
						</br>
							<div class="form-group">
								<label>Page Title</label>
								<input type="text" name="text_judul" class="form-control">
							...
							<div class="form-group">
								...
								<textarea name="text_konten" id="content" rows="5" cols="4" class="form-control"></textarea>
							</div>
							<div class="form-group">
								<label>Keyword</label>
								<textarea name="text_keyword" class="form-control" rows="3"></textarea>
							</div>
							<div class="form-group">
