	    	...
	    	<div class="row">
	    		<div class="dashboard">
		    		...
		    		<div class="col-md-9">
						...
						<form name="form1" action="<?php echo base_url()?>kategori/add_function" method="post" enctype="multipart/form-data">
						</br>
							<div class="form-group">
								<label>Category</label>
								<input type="text" name="text_kategori" class="form-control">
