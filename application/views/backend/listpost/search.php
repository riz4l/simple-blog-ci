					         ...
					         <?php if($row->artikel_status=="1"){?>
					          ...
					          <div class="caption">
					            ...
					            <p class=""><a href="<?php echo base_url()?>posting/edit/<?php echo $row->id_artikel; ?>" class="btn btn-primary" role="button"><span class="glyphicon glyphicon-pencil"></span> Edit</a>
					            			<a href="<?php echo base_url()?>listpost/delete/<?php echo $row->id_artikel;?>" onclick="return confirm('Apakah anda yakin?');" class="btn btn-danger" role="button"><span class="glyphicon glyphicon-trash"></span> Delete</a></p>
					          </div>
					        </div>
				      	</div>
						<!-- Modal -->
